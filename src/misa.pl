...
###Modification date: 18/11/19 (version 1.0)
###
###_______________________________________________________________________________
###
## _______________________________________________________________________________
...
open (IN, "./data/$ARGV[0]") || die ("\nError in $0: FASTA file doesn't exist: $! !\n\n");
open (OUT, ">./data/$ARGV[0].misa");
#print OUT "ID\tSSR nr.\tSSR type\tSSR\tsize\tstart\tend\n"; #write off by Junyang Yue


# Reading arguments #

open (SPECS, "./src/misa.ini") || die ("\nError in $0: Specifications file doesn't exist: $! !\n\n");
...
open (OUT, ">./data/$ARGV[0].statistics");
